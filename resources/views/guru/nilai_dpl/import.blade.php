<x-app-layout>
    ...
    <div class="py-12 bg-gray-50 min-h-screen">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="mb-4">
                <a href="{{ route('guru.nilai_dpl.index', $rombel && $dimensi ? ['rombel_id' => $rombel->id, 'dimensi_id' => $dimensi->id] : []) }}" class="inline-flex items-center text-sm font-medium text-gray-500 hover:text-gray-700 transition-colors">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-6">
                <div class="p-6 border-b border-gray-200">
                    <form method="GET" action="{{ route('guru.nilai_dpl.import_index') }}" class="flex flex-col md:flex-row gap-4 items-end">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 border-b border-gray-200">
                    ...
                    <div class="mb-6 bg-blue-50 border-l-4 border-blue-500 p-4 rounded-r-lg flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                        <div>
                            ...
                            <ol class="list-decimal list-inside text-sm text-blue-700 space-y-1">
                                ...
                                <li>Isi kolom setiap subdimensi dengan angka 1, 2, atau 3.</li>
                                <ul class="list-disc list-inside ml-4 text-xs">
                                    <li>1: Berkembang</li>
                                    <li>2: Cakap</li>
                                    <li>3: Mahir</li>
                                </ul>
                                <li>Kosongkan sel jika subdimensi tersebut tidak diamati.</li>
                                <li>Unggah file Excel yang telah diisi.</li>
                            </ol>
                        </div>
                        <a href="{{ route('guru.nilai_dpl.download_format', ['rombel_id' => $rombel->id, 'dimensi_id' => $dimensi->id]) }}" class="inline-flex items-center px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-md font-semibold text-xs shadow transition-colors text-center whitespace-nowrap">
                    ...
                    <form action="{{ route('guru.nilai_dpl.import_store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
