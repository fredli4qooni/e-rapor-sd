<x-app-layout>
    ...
    <div class="py-12 bg-gray-50 min-h-screen">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="mb-4">
                <a href="{{ route('guru.nilai_p3.index', $rombel && $dimensi ? ['rombel_id' => $rombel->id, 'dimensi_id' => $dimensi->id] : []) }}" class="inline-flex items-center text-sm font-medium text-gray-500 hover:text-gray-700 transition-colors">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-6">
                <div class="p-6 border-b border-gray-200">
                    <form method="GET" action="{{ route('guru.nilai_p3.import_index') }}" class="flex flex-col md:flex-row gap-4 items-end">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 border-b border-gray-200">
                    ...
                    <div class="mb-6 bg-blue-50 border-l-4 border-blue-500 p-4 rounded-r-lg flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                        <div>
                            <h4 class="font-bold text-blue-800 mb-2">Instruksi Import: Kelas {{ $rombel->nama_rombel }} - Dimensi: {{ $dimensi->nama_dimensi }}</h4>
                            <ol class="list-decimal list-inside text-sm text-blue-700 space-y-1">
                                <li>Unduh format template Excel khusus kelas ini.</li>
                                <li>Isi kolom setiap subelemen dengan angka 1, 2, 3, atau 4.</li>
                                <ul class="list-disc list-inside ml-4 text-xs">
                                    <li>1: Mulai Berkembang</li>
                                    <li>2: Sedang Berkembang</li>
                                    <li>3: Berkembang Sesuai Harapan</li>
                                    <li>4: Sangat Berkembang</li>
                                </ul>
                                <li>Kosongkan sel jika subelemen tersebut tidak diamati.</li>
                                <li>Unggah file Excel yang telah diisi.</li>
                            </ol>
                        </div>
                        <a href="{{ route('guru.nilai_p3.download_format', ['rombel_id' => $rombel->id, 'dimensi_id' => $dimensi->id]) }}" class="inline-flex items-center px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-md font-semibold text-xs shadow transition-colors text-center whitespace-nowrap">
                    ...
                    <form action="{{ route('guru.nilai_p3.import_store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
