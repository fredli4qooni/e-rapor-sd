                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="space-y-4">
                        <div>
                            ...
                            <x-text-input id="nama_rombel" name="nama_rombel" type="text" class="mt-1 block w-full" :value="old('nama_rombel', $rombel->nama_rombel)" required autofocus />
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <select id="tingkat" name="tingkat" class="mt-1 block w-full border-gray-300 focus:border-red-500 focus:ring-red-500 rounded-md shadow-sm" required>
                                    ...
                                    @for($i=1; $i<=6; $i++)
                                        <option value="{{ $i }}" {{ old('tingkat', $rombel->tingkat) == $i ? 'selected' : '' }}>Kelas {{ $i }}</option>
                                    @endfor
                                </select>
                            ...
                            <div>
                                ...
                                <select id="fase" name="fase" class="mt-1 block w-full border-gray-300 focus:border-red-500 focus:ring-red-500 rounded-md shadow-sm">
                                    <option value="">-- Pilih --</option>
                                    <option value="A" {{ old('fase', $rombel->fase) == 'A' ? 'selected' : '' }}>Fase A (Kelas 1-2)</option>
                                    <option value="B" {{ old('fase', $rombel->fase) == 'B' ? 'selected' : '' }}>Fase B (Kelas 3-4)</option>
                                    <option value="C" {{ old('fase', $rombel->fase) == 'C' ? 'selected' : '' }}>Fase C (Kelas 5-6)</option>
                                </select>
                        ...
                        <div>
                            ...
                            <select id="jenis_rombel" name="jenis_rombel" class="mt-1 block w-full border-gray-300 focus:border-red-500 focus:ring-red-500 rounded-md shadow-sm" required>
                                <option value="REGULER" {{ old('jenis_rombel', $rombel->jenis_rombel) == 'REGULER' ? 'selected' : '' }}>REGULER</option>
                                <option value="PILIHAN" {{ old('jenis_rombel', $rombel->jenis_rombel) == 'PILIHAN' ? 'selected' : '' }}>PILIHAN</option>
                                <option value="EKSKUL" {{ old('jenis_rombel', $rombel->jenis_rombel) == 'EKSKUL' ? 'selected' : '' }}>EKSKUL</option>
                            </select>
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <select id="kurikulum" name="kurikulum" class="mt-1 block w-full border-gray-300 focus:border-red-500 focus:ring-red-500 rounded-md shadow-sm" required>
                                <option value="Merdeka" {{ old('kurikulum', $rombel->kurikulum) == 'Merdeka' ? 'selected' : '' }}>Kurikulum Merdeka</option>
                                <option value="K13" {{ old('kurikulum', $rombel->kurikulum) == 'K13' ? 'selected' : '' }}>Kurikulum 2013</option>
                            </select>
