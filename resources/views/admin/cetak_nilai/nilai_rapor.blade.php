    ...
    <div class="py-6 max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="bg-white rounded-md shadow-md overflow-hidden mb-6">
            <div class="bg-indigo-800 text-white px-6 py-4 font-bold tracking-wider uppercase text-sm border-b border-indigo-900">
                Pilih Kelas untuk Cetak Nilai Rapor
            </div>
            <div class="p-4 border-b">
                <form action="{{ route('admin.cetak_nilai.nilai_rapor.index') }}" method="GET" class="flex flex-col sm:flex-row gap-4 items-end">
            ...
            <div class="bg-white rounded-md shadow-md overflow-hidden">
                <div class="p-6 bg-gray-50 border-b flex flex-col md:flex-row justify-between items-center gap-4">
                    ...
                    <div class="flex gap-2">
                        <a href="{{ route('admin.cetak_nilai.nilai_rapor.generate_kelas', $rombel_id) }}" target="_blank" class="inline-flex items-center px-4 py-2 bg-indigo-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-indigo-700 active:bg-indigo-800 focus:outline-none focus:border-indigo-900 focus:ring ring-indigo-300 disabled:opacity-25 transition ease-in-out duration-150 shadow-md">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                <tr class="hover:bg-gray-50 transition">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-center">
                                        <a href="{{ route('admin.cetak_nilai.nilai_rapor.generate_siswa', $siswa->id) }}" target="_blank" class="inline-flex items-center px-3 py-1.5 bg-blue-100 text-blue-700 hover:bg-blue-200 rounded font-semibold text-xs transition">
                                            Generate PDF
                                        </a>
                                    </td>
                                </tr>
                ...
                <div class="p-4 bg-yellow-50 text-yellow-700 text-xs border-t border-yellow-200">
                    <span class="font-bold">Info Penting:</span> Halaman nilai rapor memuat tabel nilai akhir mata pelajaran, deskripsi kompetensi, ekstrakurikuler, ketidakhadiran, dan catatan wali kelas. Pastikan data sudah diinput sebelum mencetak PDF.
                </div>
            </div>
        @endif
