    ...
    <div class="py-6 space-y-6 max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="bg-white rounded-md shadow-md overflow-hidden">
            <div class="bg-[#8B1515] text-white px-6 py-4 font-bold tracking-wider uppercase text-sm border-b border-red-800 flex justify-between items-center">
                <span>Form Edit Kelompok Mapel</span>
                <a href="{{ route('admin.kelompok_mapel.index') }}" class="text-sm font-semibold text-red-100 hover:text-white">Kembali</a>
            </div>
            
            <form action="{{ route('admin.kelompok_mapel.update', $kelompokMapel->id) }}" method="POST" class="p-6">
                @csrf
                @method('PUT')
                ...
                <div class="space-y-4 max-w-2xl">
                    <div>
                        ...
                        <x-text-input id="nama_kelompok" name="nama_kelompok" type="text" class="mt-1 block w-full" :value="old('nama_kelompok', $kelompokMapel->nama_kelompok)" placeholder="Cth: Kelompok A (Wajib)" required autofocus />
                    ...
                    <div>
                        ...
                        <x-text-input id="jenis_kelompok" name="jenis_kelompok" type="text" class="mt-1 block w-full" :value="old('jenis_kelompok', $kelompokMapel->jenis_kelompok)" placeholder="Cth: Umum, Peminatan, Muatan Lokal" />
