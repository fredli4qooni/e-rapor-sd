<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-white leading-tight">
            {{ __('Tambah Kegiatan Kokurikuler') }}
        </h2>
    </x-slot>
    ...
    <div class="py-6 space-y-6 max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="bg-white rounded-md shadow-md overflow-hidden">
            <div class="bg-[#8B1515] text-white px-6 py-4 font-bold tracking-wider uppercase text-sm border-b border-red-800 flex justify-between items-center">
                <span>Form Tambah Kegiatan Kokurikuler</span>
                <a href="{{ route('admin.p5.proyek.index', ['fase' => request('fase'), 'p5_tema_id' => request('p5_tema_id')]) }}" class="text-sm font-semibold text-red-100 hover:text-white">Kembali</a>
            </div>
            
            <form action="{{ route('admin.p5.proyek.store') }}" method="POST" class="p-6">
                @csrf
