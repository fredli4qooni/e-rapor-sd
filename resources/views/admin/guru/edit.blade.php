            ...
            <form action="{{ route('admin.guru.update', $guru->id) }}" method="POST" class="p-6">
                ...
                <div class="space-y-4 max-w-2xl">
                    <div>
                        ...
                        <x-text-input id="nama_lengkap" name="nama_lengkap" type="text" class="mt-1 block w-full" :value="old('nama_lengkap', $guru->nama_lengkap)" required autofocus />
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <x-text-input id="gelar_depan" name="gelar_depan" type="text" class="mt-1 block w-full" :value="old('gelar_depan', $guru->gelar_depan)" placeholder="Cth: Drs." />
                        ...
                        <div>
                            ...
                            <x-text-input id="gelar_belakang" name="gelar_belakang" type="text" class="mt-1 block w-full" :value="old('gelar_belakang', $guru->gelar_belakang)" placeholder="Cth: S.Pd." />
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <x-text-input id="nip" name="nip" type="text" class="mt-1 block w-full bg-gray-50 text-gray-500" :value="old('nip', $guru->nip)" readonly />
                            <x-input-error class="mt-2" :messages="$errors->get('nip')" />
                        </div>
                        <div>
                            <x-input-label for="nip_tampil" :value="__('NIP/NIY yang Tampil di Rapor')" class="text-gray-700 font-semibold" />
                            <x-text-input id="nip_tampil" name="nip_tampil" type="text" class="mt-1 block w-full" :value="old('nip_tampil', $guru->nip_tampil)" />
