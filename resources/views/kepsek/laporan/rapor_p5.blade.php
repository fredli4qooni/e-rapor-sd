    ...
    <div class="py-6 max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="bg-white rounded-md shadow-md overflow-hidden mb-6">
            ...
            <div class="p-4 border-b">
                <form action="{{ route('kepsek.laporan.rapor_p5') }}" method="GET" class="flex flex-col sm:flex-row gap-4 items-end">
            ...
            <div class="bg-white rounded-md shadow-md overflow-hidden">
                <div class="p-6 bg-gray-50 border-b flex flex-col md:flex-row justify-between items-center gap-4">
                    ...
                    <div class="flex gap-2">
                        <a href="{{ route('kepsek.laporan.rapor_p5_kelas', $rombel_id) }}" target="_blank" class="inline-flex items-center px-4 py-2 bg-green-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-green-700 active:bg-green-800 focus:outline-none focus:border-green-900 focus:ring ring-green-300 disabled:opacity-25 transition ease-in-out duration-150 shadow-md">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                <tr class="hover:bg-gray-50 transition">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-center">
                                        <a href="{{ route('kepsek.laporan.rapor_p5_siswa', $siswa->id) }}" target="_blank" class="inline-flex items-center px-3 py-1.5 bg-blue-100 text-blue-700 hover:bg-blue-200 rounded font-semibold text-xs transition">
                                            Generate PDF
                                        </a>
                                    </td>
                                </tr>
