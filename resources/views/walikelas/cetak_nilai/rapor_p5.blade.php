<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-white leading-tight uppercase">
            {{ __('Cetak Nilai Rapor Projek Profil Pelajar Pancasila') }}
        </h2>
    </x-slot>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg border-t-4 border-red-800">
                <div class="p-6 text-gray-900">
                    <h3 class="text-lg font-bold text-gray-800 mb-6 uppercase border-b pb-2">Cetak Nilai Rapor Projek Profil Pelajar Pancasila</h3>

                    <!-- Print Settings Form -->
                    <form method="GET" action="{{ route('walikelas.cetak_nilai.rapor_p5.generate') }}" target="_blank" class="mb-8 p-4 border border-gray-200 rounded-md bg-white shadow-sm" id="print-settings-form">
                    ...
                    <div class="border border-gray-300 rounded-md bg-white">
                        <div class="flex justify-end p-4 gap-2 bg-gray-50 border-b">
                            ...
                            <button onclick="document.getElementById('print-settings-form').submit();" class="inline-flex items-center px-4 py-2 bg-red-900 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-red-800 transition">
                                ...
                                Generate Rapor Projek Kelas ini
                            </button>
                            ...
                            <table class="min-w-full divide-y divide-gray-200">
                                <thead class="bg-red-900 text-white shadow">
                                    <tr class="text-center text-xs uppercase">
                                        ...
                                        <th class="px-4 py-3 border border-red-800 w-48 align-middle">File Rapor Siswa</th>
                                        ...
                                        <th class="px-4 py-3 border border-red-800 w-48 align-middle">
                                            <div x-data="{ openAksi: false }" class="relative inline-block text-left">
                                                ...
                                                <div x-show="openAksi" style="display: none;" class="origin-top-right absolute right-0 mt-2 w-48 rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5 divide-y divide-gray-100 z-50">
                                                    <div class="py-1">
                                                        <form method="POST" action="{{ route('walikelas.cetak_nilai.rapor_p5.toggle') }}">
                                                            @csrf
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    ...
                                    <tr class="hover:bg-red-50 transition-colors {{ $index % 2 == 0 ? 'bg-red-50/20' : 'bg-white' }}">
                                        ...
                                        <td class="px-4 py-3 text-sm text-center border border-gray-300">
                                            <a href="{{ route('walikelas.cetak_nilai.rapor_p5.generate', $siswa->id) }}" target="_blank" class="text-blue-500 hover:text-blue-700 hover:underline uppercase font-semibold text-xs">Rapor P5 {{ $siswa->nama_lengkap }}</a>
                                        </td>
                                        <td class="px-4 py-3 text-sm text-center border border-gray-300">
                                            <a href="{{ route('walikelas.cetak_nilai.rapor_p5.generate', $siswa->id) }}" target="_blank" class="inline-flex items-center px-3 py-1.5 bg-red-900 border border-transparent rounded-md font-bold text-xs text-white uppercase tracking-widest hover:bg-red-800 shadow-sm transition">
