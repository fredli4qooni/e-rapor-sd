...
class ReferensiP5KelompokController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('admin.referensi_p5.kelompok.index', compact('kelompoks', 'fase'));
    }

    public function create()
    {
        $gurus = \App\Models\User::where('role', 'guru')->get();
        return view('admin.referensi_p5.kelompok.create', compact('gurus'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.referensi_p5.kelompok.index')->with('status', 'Kelompok Projek berhasil ditambahkan!');
    }

    public function edit(\App\Models\P5Kelompok $kelompok)
    {
        $gurus = \App\Models\User::where('role', 'guru')->get();
        return view('admin.referensi_p5.kelompok.edit', compact('kelompok', 'gurus'));
    }
    ...
    public function update(Request $request, \App\Models\P5Kelompok $kelompok)
    {
        ...
        return redirect()->route('admin.referensi_p5.kelompok.index')->with('status', 'Kelompok Projek berhasil diperbarui!');
    }
    ...
    public function show(\App\Models\P5Kelompok $kelompok)
    {
        ...
        return view('admin.referensi_p5.kelompok.show', compact('kelompok', 'semuaSiswa', 'semuaKegiatan', 'rombels'));
    }

    public function destroy(\App\Models\P5Kelompok $kelompok)
    {
        $kelompok->delete();
        return redirect()->route('admin.referensi_p5.kelompok.index')->with('status', 'Kelompok Projek berhasil dihapus!');
    }
    ...
    public function tambahKegiatan(Request $request, \App\Models\P5Kelompok $kelompok)
    {
        ...
        return back()->with('status', 'Projek berhasil ditambahkan ke kelompok!');
    }
    ...
    public function hapusKegiatan(\App\Models\P5Kelompok $kelompok, \App\Models\P5Proyek $kegiatan)
    {
        ...
        return back()->with('status', 'Projek berhasil dihapus dari kelompok!');
    }
}
