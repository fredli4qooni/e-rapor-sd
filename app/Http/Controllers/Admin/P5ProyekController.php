...
class P5ProyekController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('admin.p5.proyek.index', compact('proyeks', 'fase', 'p5_tema_id', 'temas'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.p5.proyek.create', compact('temas', 'dimensis'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.p5.proyek.index', ['fase' => $request->fase, 'p5_tema_id' => $request->p5_tema_id])->with('status', 'Kegiatan Kokurikuler berhasil ditambahkan!');
    }
    ...
    public function edit(\App\Models\P5Proyek $proyek)
    {
        ...
        return view('admin.p5.proyek.edit', compact('proyek', 'temas', 'dimensis', 'selectedSubElemens'));
    }
    ...
    public function update(Request $request, \App\Models\P5Proyek $proyek)
    {
        ...
        return redirect()->route('admin.p5.proyek.index', ['fase' => $request->fase, 'p5_tema_id' => $request->p5_tema_id])->with('status', 'Kegiatan Kokurikuler berhasil diperbarui!');
    }
    ...
    public function destroy(\App\Models\P5Proyek $proyek)
    {
        $fase = $proyek->fase;
        $proyek->delete();
        return redirect()->route('admin.p5.proyek.index', ['fase' => $fase])->with('status', 'Proyek P5 berhasil dihapus!');
    }
}
